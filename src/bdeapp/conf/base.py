...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "bdeapp"),
        "USER": config("DB_USER", "bdeapp"),
        "PASSWORD": config("DB_PASSWORD", "bdeapp"),
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "bdeapp.utils.context_processors.settings",
            ],
...
WSGI_APPLICATION = "bdeapp.wsgi.application"
...
DEFAULT_FROM_EMAIL = "bdeapp@example.com"
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": LOGGING_DIR / "bdeapp.log",
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "bdeapp.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "bdeapp_sessionid"
...
CSRF_FAILURE_VIEW = "bdeapp.accounts.views.csrf_failure"
